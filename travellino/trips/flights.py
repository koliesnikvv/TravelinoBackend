    ...
    def construct_flights(self):
        ...
        for itinerary in self.flight['itineraries']:
            ...
            if len(self.flight['itineraries'][index]['segments']) == 2:  # one stop flight
                ...
                offer[str(index) + 'firstFlightAirline'] = self.flight['itineraries'][index]['segments'][0][
                    'carrierCode']
                ...
                offer[str(index) + 'firstFlightArrivalDuration'] = self.flight['itineraries'][index]['segments'][0][
                    'duration']
                ...
                offer[str(index) + 'secondFlightAirline'] = self.flight['itineraries'][index]['segments'][1][
                    'carrierCode']
                ...
                offer[str(index) + 'secondFlightArrivalDuration'] = self.flight['itineraries'][index]['segments'][1][
                    'duration']
                offer[str(index) + 'FlightTotalDuration'] = self.flight['itineraries'][index]['duration'][2:]
                offer[str(index) + 'stop_time'] = get_stoptime(
                    self.flight['itineraries'][index]['duration'],
